...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItem(ItemDtoIn itemDtoIn, long itemId, long userId) {
    ...
    public ResponseEntity<Object> searchAvailableItemsByPartOfNameOrDescription(String text, long userId, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
